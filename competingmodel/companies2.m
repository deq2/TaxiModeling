function [avg med sd revenue] = companies2(taxis1, taxis2, taxis3, P1, P2, P3)
            ...
            for i = 1:n1       %Looping through all nodes
                for j = i:n2
                    ...
                    if r1(minute+i+j-1) < B(j,i)  %If someone needs a taxi from node j to node i
                        ...
                        if rcomp < P3 && tiu3(taxin(i, tloc3, tiu3, A, taxis3)) < p(minute +i+j-2)
                            a = taxin(i, tloc3, tiu3, A, taxis3);  %Index of taxi who takes next passenger
                            tiu3(a) = A(j,i) + tiu3(a,1);
                            tloc3(a) = i;
                            WAIT3(index3) = tiu3(a) - A(j,i);
                            index3 = index3 + 1;
                            revenue3 = revenue3 + C(j,i);
                             
                            
                        elseif rcomp < P2 + P3 && tiu2(taxin(i, tloc2, tiu2, A, taxis2)) < p(minute +i+j-2)
                            a = taxin(i, tloc2, tiu2, A, taxis2);  %Index of taxi who takes next passenger
                            tiu2(a) = A(j,i) + tiu2(a,1);
                            tloc2(a) = i;
                            WAIT2(index2) = tiu2(a) - A(j,i);
                            index2 = index2 + 1;
                            revenue2 = revenue2 + C(j,i);
                            
                 
                        else
                            a = taxin(i, tloc1, tiu1, A, taxis1);  %Index of taxi who takes next passenger
                            tiu1(a) = A(j,i) + tiu1(a,1);
                            tloc1(a) = i;
                            WAIT1(index1) = tiu1(a) - A(j,i);
                            index1 = index1 + 1;
                            revenue1 = revenue1 + C(j,i);
